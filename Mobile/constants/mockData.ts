...
export const MOCK_LAWYERS: Lawyer[] = [
  ...
  },
  {
    ...
    verified: true,
    verifiedPlus: true,
    barCouncilId: "BAR/DL/2010/1122",
    experienceYears: 14,
    city: "Delhi",
    state: "Delhi",
    servesRemote: true,
    specializations: ["Criminal Law", "Bail", "IPC"],
    languages: ["English", "Hindi"],
    courts: [{ name: "Delhi High Court", since: 2010 }],
    cases: { total: 450, won: 400, lost: 30, settled: 20, winRatePercent: 88, byCategory: { criminal: 400 } },
    fees: { chatPerMinuteInr: 30, call30minInr: 1500, call60minInr: 2500, documentReviewInr: 800, inPersonPerHourInr: 3000 },
    rating: { average: 4.9, totalReviews: 120, breakdown: {} },
    isOnline: true,
    responseTimeMinutes: 2,
    bio: "Top criminal lawyer in Delhi with extensive experience in High Court.",
    initials: "AM",
    avatarColor: "#4F46E5"
  },
  {
    ...
    verified: true,
    verifiedPlus: false,
    barCouncilId: "BAR/MH/2014/4455",
    experienceYears: 10,
    city: "Mumbai",
    state: "Maharashtra",
    servesRemote: true,
    specializations: ["Family Law", "Divorce", "Maintenance"],
    languages: ["English", "Hindi", "Marathi"],
    courts: [{ name: "Bombay High Court", since: 2014 }],
    cases: { total: 300, won: 260, lost: 20, settled: 20, winRatePercent: 86, byCategory: { family: 280 } },
    fees: { chatPerMinuteInr: 25, call30minInr: 1200, call60minInr: 2000, documentReviewInr: 600, inPersonPerHourInr: 2500 },
    rating: { average: 4.8, totalReviews: 95, breakdown: {} },
    isOnline: true,
    responseTimeMinutes: 5,
    bio: "Specialized in matrimonial and family disputes in Mumbai.",
    initials: "NS",
    avatarColor: "#EC4899"
  },
  {
    ...
    verified: true,
    verifiedPlus: true,
    barCouncilId: "BAR/UP/2008/8899",
    experienceYears: 18,
    city: "Noida",
    state: "Uttar Pradesh",
    servesRemote: true,
    specializations: ["Corporate Law", "Contracts", "M&A"],
    languages: ["English", "Hindi"],
    courts: [{ name: "NCLT Delhi", since: 2016 }],
    cases: { total: 200, won: 180, lost: 10, settled: 10, winRatePercent: 90, byCategory: { corporate: 180 } },
    fees: { chatPerMinuteInr: 40, call30minInr: 2000, call60minInr: 3500, documentReviewInr: 1500, inPersonPerHourInr: 5000 },
    rating: { average: 5.0, totalReviews: 45, breakdown: {} },
    isOnline: true,
    responseTimeMinutes: 10,
    bio: "Corporate law veteran providing strategic legal advice to startups and enterprises.",
    initials: "RS",
    avatarColor: "#10B981"
  },
  {
    ...
    verified: true,
    verifiedPlus: false,
    barCouncilId: "BAR/DL/2012/6677",
    experienceYears: 12,
    city: "Delhi",
    state: "Delhi",
    servesRemote: true,
    specializations: ["Property Law", "RERA", "Civil"],
    languages: ["English", "Hindi"],
    courts: [{ name: "Saket Court", since: 2012 }],
    cases: { total: 320, won: 280, lost: 25, settled: 15, winRatePercent: 87, byCategory: { property: 250 } },
    fees: { chatPerMinuteInr: 35, call30minInr: 1800, call60minInr: 3000, documentReviewInr: 1000, inPersonPerHourInr: 3500 },
    rating: { average: 4.7, totalReviews: 80, breakdown: {} },
    isOnline: true,
    responseTimeMinutes: 4,
    bio: "Expert in property verification and RERA disputes.",
    initials: "PV",
    avatarColor: "#F59E0B"
  },
  {
    ...
    verified: true,
    verifiedPlus: false,
    barCouncilId: "BAR/HR/2016/3344",
    experienceYears: 8,
    city: "Gurgaon",
    state: "Haryana",
    servesRemote: true,
    specializations: ["Civil Law", "Recovery", "Suits"],
    languages: ["English", "Hindi"],
    courts: [{ name: "Gurgaon District Court", since: 2016 }],
    cases: { total: 150, won: 120, lost: 20, settled: 10, winRatePercent: 80, byCategory: { civil: 130 } },
    fees: { chatPerMinuteInr: 20, call30minInr: 1000, call60minInr: 1800, documentReviewInr: 500, inPersonPerHourInr: 2000 },
    rating: { average: 4.6, totalReviews: 50, breakdown: {} },
    isOnline: true,
    responseTimeMinutes: 3,
    bio: "Focused on efficient civil recovery and litigation in Gurgaon.",
    initials: "KK",
    avatarColor: "#6366F1"
  },
  {
    id: "6",
    name: "Adv. Sneha Jain",
    designation: "Employment Law Attorney",
    verified: true,
    verifiedPlus: false,
    barCouncilId: "BAR/PN/2014/1100",
    experienceYears: 10,
    city: "Pune",
    state: "Maharashtra",
    servesRemote: true,
    specializations: ["Employment Law", "Labour Law", "POSH"],
    languages: ["English", "Hindi", "Marathi"],
    courts: [{ name: "Pune Labour Court", since: 2014 }],
    cases: { total: 240, won: 210, lost: 15, settled: 15, winRatePercent: 87, byCategory: { employment: 220 } },
    fees: { chatPerMinuteInr: 30, call30minInr: 1400, call60minInr: 2400, documentReviewInr: 700, inPersonPerHourInr: 2800 },
    rating: { average: 4.8, totalReviews: 70, breakdown: {} },
    isOnline: true,
    responseTimeMinutes: 6,
    bio: "Helping employees and companies navigate labour laws in Pune.",
    initials: "SJ",
    avatarColor: "#8B5CF6"
  },
  {
    id: "7",
    name: "Adv. Amit Tiwari",
    designation: "Criminal Defense Lawyer",
    verified: true,
    verifiedPlus: false,
    barCouncilId: "BAR/UP/2012/5566",
    experienceYears: 12,
    city: "Lucknow",
    state: "Uttar Pradesh",
    servesRemote: true,
    specializations: ["Criminal Law", "Bail", "Appeals"],
    languages: ["English", "Hindi"],
    courts: [{ name: "Lucknow High Court", since: 2012 }],
    cases: { total: 380, won: 340, lost: 25, settled: 15, winRatePercent: 89, byCategory: { criminal: 350 } },
    fees: { chatPerMinuteInr: 28, call30minInr: 1300, call60minInr: 2200, documentReviewInr: 600, inPersonPerHourInr: 2400 },
    rating: { average: 4.7, totalReviews: 110, breakdown: {} },
    isOnline: true,
    responseTimeMinutes: 2,
    bio: "Strong criminal defense and bail specialist in Lucknow.",
    initials: "AT",
    avatarColor: "#F43F5E"
  },
  {
    ...
    designation: "Taxation Law Expert",
    verified: true,
    verifiedPlus: true,
    barCouncilId: "BAR/RJ/2006/7788",
    experienceYears: 20,
    city: "Jaipur",
    state: "Rajasthan",
    servesRemote: true,
    ...
    languages: ["English", "Hindi"],
    courts: [{ name: "Rajasthan High Court", since: 2006 }],
    cases: { total: 500, won: 460, lost: 20, settled: 20, winRatePercent: 92, byCategory: { tax: 480 } },
    fees: { chatPerMinuteInr: 45, call30minInr: 2500, call60minInr: 4500, documentReviewInr: 2000, inPersonPerHourInr: 6000 },
    rating: { average: 5.0, totalReviews: 150, breakdown: {} },
    isOnline: true,
    responseTimeMinutes: 8,
    bio: "Jaipur's leading tax consultant and litigator.",
    initials: "RB",
    avatarColor: "#3B82F6"
  },
  {
    id: "9",
    name: "Adv. Meera Iyer",
    designation: "Family & Divorce Lawyer",
    verified: true,
    verifiedPlus: false,
    barCouncilId: "BAR/TN/2012/2233",
    experienceYears: 12,
    city: "Chennai",
    state: "Tamil Nadu",
    servesRemote: true,
    ...
    courts: [{ name: "Madras High Court", since: 2012 }],
    cases: { total: 280, won: 240, lost: 20, settled: 20, winRatePercent: 85, byCategory: { family: 260 } },
    fees: { chatPerMinuteInr: 32, call30minInr: 1600, call60minInr: 2800, documentReviewInr: 900, inPersonPerHourInr: 3200 },
    rating: { average: 4.8, totalReviews: 85, breakdown: {} },
    isOnline: true,
    responseTimeMinutes: 5,
    bio: "Advocating for family rights and fair settlements in Chennai.",
    initials: "MI",
    avatarColor: "#D946EF"
  },
  {
    ...
    designation: "Corporate & Commercial Lawyer",
    verified: true,
    verifiedPlus: true,
    barCouncilId: "BAR/GJ/2004/9900",
    experienceYears: 22,
    city: "Ahmedabad",
    state: "Gujarat",
    servesRemote: true,
    specializations: ["Corporate Law", "Arbitration", "Commercial"],
    languages: ["English", "Gujarati", "Hindi"],
    courts: [{ name: "Gujarat High Court", since: 2004 }],
    cases: { total: 600, won: 540, lost: 30, settled: 30, winRatePercent: 90, byCategory: { corporate: 500 } },
    fees: { chatPerMinuteInr: 50, call30minInr: 3000, call60minInr: 5500, documentReviewInr: 2500, inPersonPerHourInr: 8000 },
    rating: { average: 4.9, totalReviews: 180, breakdown: {} },
    isOnline: true,
    responseTimeMinutes: 10,
    bio: "Veteran commercial lawyer handling high-stakes corporate disputes.",
    initials: "VD",
    avatarColor: "#14B8A6"
  },
];
